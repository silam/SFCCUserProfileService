...
{
    public class PostSqlDbUserProfile
    {
        [FunctionName("PostSqlDbUserProfile")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "SqlDb/UserProfiles")] HttpRequest req,
            ILogger log, ExecutionContext context)
        {
            ...
            if (req.Method == "POST")
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("dbo.PostUserProfile", conn);
            ...
            {
                return new OkObjectResult("Error not a POST");
